		...
		<div class="row">
			...
			<div class="col">
				<div class="card">
					<div class="card-body">
						<div>
							<span style="color:#b02928; font-size: 13px; font-weight: bolder;">LAPOR GANGGUAN</span>
							<hr>
							<!--  -->
							<div class="row">
								<div class="col""> 
									<a href="<?php echo base_url()."penyedia/laporgangguan/add"?>" class="btn btn-primary btn-sm"><i class="fa fa-paper-plane" aria-hidden="true"></i> Laporkan Gangguan</a>
									<div class="mt-2"><small>Laporkan ketika terjadi gangguan pada SPSE, misalnya ketika SPSE tidak dapat diakses ataupun permasalahan lainnya yang terkait dengan sistem.</small></div>
									<br>
									<!-- table -->
									<div class="table-responsive">
										...
										<thead>
											<tr>
												<th colspan="7" class="text-center" style="background-color:white; font-weight: ">Laporan gangguan yang telah di kirim.</th>
											</tr>
											<tr align="center">
												<th>No.</th>
												<th>Tanggal</th>
										...
										<tbody >
											<?php $no = 1; foreach ($dataaduan as $dataaduan): ?>
											<tr>
												<td width="1%" align="center">
													<?php echo $no++; ?>
												</td>
												<td align="center" width="15%">
													<?php echo $dataaduan->tanggal ?>
												</td>
												<td  width="25%">
													<?php echo $dataaduan->judul ?>
												</td>
												<td>
													<?php echo $dataaduan->deskripsi ?>
												</td>
												<td align="center" width="1%">
													<div class="btn-group" role="group" aria-label="Default button group">
														<a href="<?php echo site_url('penyedia/laporgangguan/lihat/'.$dataaduan->id_aduan) ?>" class="btn btn-primary btn-sm"><i class="fa fa-search" aria-hidden="true"></i></a>
													</div>
												</td>
											</tr>
											<?php endforeach; ?>											
