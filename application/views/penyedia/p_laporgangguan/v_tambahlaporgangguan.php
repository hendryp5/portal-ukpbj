					...
					<div class="card-body">
						<div>
							...
							<div class="row">
								<div class="col"">
									<!-- form -->
									<form action="<?php base_url('penyedia/laporgangguan/add') ?>" method="post"
									...
									<div class="row">
										...
										<div class="col-sm-4">
										    ...
										    <select class="form-control show-tick" name="versi" required>
												<option value="">-- Harap Pilih --</option>
									...
									<div class="form-group">
									    ...
									    <!-- judul -->
									    <input placeholder="Masukkan judul yang sesuai dengan permasalahan." type="text" id="judul" name="judul"
									...
									<div class="form-group">
									    ...
									    <!-- deskripsi -->
										<textarea class="form-control" name="deskripsi" placeholder="Masukkan keterangan/deskripsi tentang permasalahan." rows="3" required></textarea>
									</div>
									...
									<div class="form-group">
									    ...
									    <input type="file" accept=".jpg,.png,.jpeg" class="form-control"
												placeholder="File Pendukung" name="file_pendukung" required/>
									    <small id="emailHelp" class="form-text text-muted">Catatan: Hanya file yang berekstensi .jpg, .png, .jpeg yang diterima.</small>
									</div>

									<button type="submit" class="btn btn-primary btn-lg btn-block"><span style="font-weight:bold;">KIRIM</span>
										</button>
								</form>
								</div>
							</div>
