...
<head>
	...
	<title>Lihat Aduan | UKPBJ Kab. Tanah Laut - Center of Excellence</title>
		...
		<div class="container-fluid">
			<div class="block-header">
				<ol class="breadcrumb">
                    ...
                    <li class="active">
						<a href="javascript:void(0);">
							<i class="material-icons"></i> Lihat Aduan
						</a>
					</li>
				</ol>
			</div>
						...
						<div class="body">
							<!-- <form action="<?php base_url('penyedia/aduan/add') ?>" method="post"
								...
								<div class="row clearfix">
									<div class="col-sm-4">
										...
										<select class="form-control show-tick" name="kategori">
											<option value="<?php echo $dataaduan->kategori?>"><?php echo $dataaduan->kategori?></option>
									...
									<div class="col-sm-4">
                                        ...
                                        <option value="<?php echo $dataaduan->tipe?>"><?php echo $dataaduan->tipe?></option>
									...
									<div class="col-sm-4">
                                        ...
                                        <option value="<?php echo $dataaduan->versi?>"><?php echo $dataaduan->versi?></option>
								...
								<div class="form-group">
									...
									<div class="">
										<input value="<?php echo $dataaduan->judul ?>" placeholder="Masukkan Judul" type="text" id="judul" name="judul"
								...
								<div class="form-group">
									...
									<div class="">
										<input value="<?php echo $dataaduan->deskripsi ?>" placeholder="Masukkan Keterangan" type="text" id="judul" name="deskripsi"
											class="form-control" readonly>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div>
                                    <a data-fancybox="gallery" href="<?php base_url('assets/upload/file_aduan/penyedia/'.$dataaduan->file_pendukung)?>">
                                    <img width="50%" src="<?php echo base_url('assets/upload/file_aduan/penyedia/'.$dataaduan->file_pendukung) ?>"
                                     />
                                    </a>
									</div>
								</div>
								<a href="<?php echo site_url('penyedia/aduan') ?>" class="btn bg-red btn-block btn-lg waves-effect">KEMBALI</a>
							<!-- </form> -->
						</div>
					</div>
				</div>
