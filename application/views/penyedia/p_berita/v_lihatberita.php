					...
					<div class="card-body">
						<div>
							...
							<div class="d-flex justify-content-between">
								...
								<span><a href="<?php echo site_url();?>penyedia/beritadaninformasi/semuaberita" class="btn btn-primary btn-sm">< Kembali</a></span>
							</div>
							...
							<div class="row">
								<div class="col">
									<div class="text-center"><img width="40%" src="<?php echo base_url();?>assets/upload/file_beritainformasi/<?php echo $databerita->gambar_berita?>"></div>
									<div class="text-center" style="font-weight: bolder;"><?php echo $databerita->judul_berita?></div>
									<div class="text-center">Oleh: <?php echo $databerita->pembuat_berita?>, <?php echo $databerita->tanggal_berita?>, <?php echo $databerita->jenis?></div>
									<div class="mt-3" style="text-align: justify;
  text-justify: inter-word;"><?php echo $databerita->isi_berita?></div>
								</div>
							</div>	
							<!-- END BERITA -->
							<!-- * -->
