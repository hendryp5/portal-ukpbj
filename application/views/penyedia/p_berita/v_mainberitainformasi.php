		...
		<div class="row">
			...
			<div class="col">
				<div class="card">
					<div class="card-body">
						<div>
							<span style="color:#b02928; font-size: 13px; font-weight: bolder;">BERITA & INFORMASI </span>
							<hr>
							<!-- CONTENT -->
							<!-- BEGIN BERITA -->
							<div class="d-flex justify-content-between mb-1" style="color: #b02928; font-weight: bolder; font-size: 20px;">Berita Terbaru <a href="<?php echo site_url();?>penyedia/beritadaninformasi/semuaberita"><span style="color: #b02928; font-size: 13px;">Lihat Semua</span></a></div>
							<div class="row">
								<?php
								foreach ($viewberita as $viewberitashow):
									$id_berita = $viewberitashow['id_berita'];						
									$tanggalrilis = $viewberitashow['tanggal_berita'];
									$image = $viewberitashow['gambar_berita'];
									$judul = $viewberitashow['judul_berita'];
									$url = $viewberitashow['url_berita'];
									?>
									<!-- berulang -->
									<div class="col-md-6 col-lg-4 mb-4 d-flex">
										<div class="card card-shadow rounded">
											<a href="<?php site_url();?>beritadaninformasi/lihatberita/<?php echo $url;?>">
												<img width="10px;" class="card-img-top" src="<?php echo base_url();?>assets/upload/file_beritainformasi/<?php echo $image; ?>" alt="#">
											</a>
											<div class="card-body">
												<h5 class="card-title font-weight-bold">
													<a style="text-decoration: none;" class="text-dark" href="<?php site_url();?>beritadaninformasi/lihatberita/<?php echo $url;?>"><?php echo $judul;?></a>
												</h5>
												<small style="color: gray;"><?php echo $tanggalrilis;?></small>
											</div>
										</div>
									</div>
								<?php endforeach; ?>
							...
							<div class="row">
								<div class="col">
									...
									<a href="#" class="btn btn-outline-primary btn-sm">Lihat Semua Berita</a>
									</div> -->
								</div>
							</div>	
							<!-- END BERITA -->
							<!-- * -->
							<!-- BEGIN INFORMASI -->
							<hr style="border-top: 1px solid #b02928;">
							<div class="d-flex justify-content-between mb-1" style="color: #b02928; font-weight: bolder; font-size: 20px;">Informasi Terbaru <a href="<?php echo site_url();?>penyedia/beritadaninformasi/semuainformasi"><span style="color: #b02928; font-size: 13px;">Lihat Semua</span></a></div>
							<div class="row">
								<?php
								foreach ($viewinformasi as $viewinformasishow):
									$id_info = $viewinformasishow['id_berita'];						
									$tanggalrilisinfo = $viewinformasishow['tanggal_berita'];
									$imageinfo = $viewinformasishow['gambar_berita'];
									$judulinfo = $viewinformasishow['judul_berita'];
									$urlinfo = $viewinformasishow['url_berita'];
									?>
									<!-- berulang -->
									<div class="col-md-6 col-lg-4 mb-4 d-flex">
										<div class="card card-shadow rounded">
											<a href="<?php site_url();?>beritadaninformasi/lihatinformasi/<?php echo $urlinfo;?>">
												<img width="10px;" class="card-img-top lazyload blur-up lazyloaded" src="<?php echo base_url();?>assets/upload/file_beritainformasi/<?php echo $imageinfo; ?>" alt="#">
											</a>
											<div class="card-body">
												<h5 class="card-title font-weight-bold">
													<a style="text-decoration: none;" class="text-dark" href="<?php site_url();?>beritadaninformasi/lihatinformasi/<?php echo $urlinfo;?>"><?php echo $judulinfo;?></a>
												</h5>
												<small style="color: gray;"><?php echo $tanggalrilisinfo;?></small>
											</div>
										</div>
									</div>
								<?php endforeach; ?>
							...
							<div class="row">
								<div class="col">
									...
									<!-- <?php echo $pagination; ?> -->
									<!-- <div class="text-center">
									<a href="#" class="btn btn-outline-primary btn-sm">Lihat Semua Informasi</a>
									</div> -->
								</div>
							</div>	
							<!-- END INFORMASI -->					
