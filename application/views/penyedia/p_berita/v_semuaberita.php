					...
					<div class="card-body">
						<div>
							<div class="d-flex justify-content-between">
								<span style="color:#b02928; font-size: 13px; font-weight: bolder;">BERITA</span>
							...
							<!-- CONTENT -->
							<!-- BEGIN BERITA -->
							<div class="text-center mb-1" style="color: #b02928; font-weight: bolder; font-size: 20px;"><u>Semua Berita</u></div>
							<div class="row">
								<?php
								foreach ($data->result() as $viewberitainfoshow):
									$id_berita = $viewberitainfoshow->id_berita;						
									$tanggalrilis = $viewberitainfoshow->tanggal_berita;
									$image = $viewberitainfoshow->gambar_berita;
									$judul = $viewberitainfoshow->judul_berita;
									$url = $viewberitainfoshow->url_berita;
									?>
									<!-- berulang -->
									<div class="col-md-6 col-lg-4 mb-4 d-flex">
										<div class="card card-shadow rounded">
											<a href="<?php site_url();?>lihatberita/<?php echo $url;?>">
												<img width="10px;" class="card-img-top lazyload blur-up lazyloaded" src="<?php echo base_url();?>assets/upload/file_beritainformasi/<?php echo $image; ?>" alt="#">
											</a>
											<div class="card-body">
												<h5 class="card-title font-weight-bold">
													<a style="text-decoration: none;" class="text-dark" href="<?php site_url();?>lihatberita/<?php echo $url;?>"><?php echo $judul;?></a>
												</h5>
