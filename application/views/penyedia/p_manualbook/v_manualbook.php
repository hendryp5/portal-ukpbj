...
<head>
	...
	<title>Manual Book | UKPBJ Kab. Tanah Laut - Center of Excellence</title>
...
<body style="background-color: #F8F8F8">
	...
	<div class="scrollmenu d-block d-sm-none">
		...
		<a href="<?php echo site_url();?>penyedia/manualbook" style="color:#B02928;">Manual Book</a>
	</div>
	<!-- SIDEBAR -->
		...
		<div class="row">
								...
								<nav class="navigation">
									...
									<ul class="mainmenu">
										...
										<li class="activesidebar">
											<a href="<?php echo site_url();?>penyedia/manualbook"><img src="https://image.flaticon.com/icons/svg/2446/2446995.svg" width="33px"><span style="margin-left:10px; color:#b02928;"> Manual Book</span></a>
										</li>
									</ul>
								</nav>
							</div>
			...
			<div class="col">
				<div class="card">
					<div class="card-body">
						<div>
							<span style="color:#b02928; font-size: 13px; font-weight: bolder;">MANUAL BOOK</span>
							<hr>		
							<div class="row">
								<div class="col">
									<div class="jumbotron jumbotron-fluid">
										<div class="container text-center">
											<img width="100px" src="https://image.flaticon.com/icons/svg/2446/2446995.svg">
											<p class="lead">Download manual book untuk mengetahui bagaimana mengoperasikan aplikasi portal UKPBJ Kabupaten Tanah Laut.</p>
											...
											if($level == 'PENYEDIA'){?>
												<a href="<?php echo base_url();?>assets/manualbook/manual_penyedia.pdf" download>Download Manual Book</a>
											<? }else if($level == 'NONPENYEDIA'){ ?>
												<a href="<?php echo base_url();?>assets/manualbook/manual_nonpenyedia.pdf" download>Download Manual Book</a>
											<?php
											}else{
												echo 'zonk';
											}
