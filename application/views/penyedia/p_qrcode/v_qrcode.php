...
<head>
	...
	<title>QR-Code | UKPBJ Kab. Tanah Laut - Center of Excellence</title>
					...
					<div class="card-body">
						<div>
							<div class="d-flex justify-content-between">
								<span style="color:#b02928; font-size: 13px; font-weight: bolder;">QR-CODE</span>
								<span><a href="<?php echo site_url();?>penyedia/dashboard" class="btn btn-primary btn-sm">< Kembali</a></span>
							</div>
							<hr>
							<?php
							foreach ($viewqrcode as $viewqrcodeshow):
								$user_qrcode = $viewqrcodeshow['user_qrcode'];
							endforeach;
							?>
							<div class="text-center" style="font-size: 17px; font-weight: bolder;">Tanda tangan digital anda:</div>		
