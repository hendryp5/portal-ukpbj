...
<head>
	...
	<title>Ubah Profil Saya | UKPBJ Kab. Tanah Laut - Center of Excellence</title>
...
<body style="background-color: #F8F8F8">
	...
	<div class="scrollmenu d-block d-sm-none">
		...
		<a href="<?php echo site_url();?>penyedia/pengguna" style="color:#B02928;">Profil Saya</a>
								...
								<nav class="navigation">
									...
									<ul class="mainmenu">
										...
										<li class="activesidebar">
											<a href="<?php echo site_url();?>penyedia/pengguna"><img src="https://image.flaticon.com/icons/svg/609/609782.svg" width="33px"><span style="margin-left:10px; color:#b02928;"> Profil Saya</span></a>
										</li>
										<li>
					...
					<div class="card-body">
						<div>
							<div class="d-flex justify-content-between">
								<span style="color:#b02928; font-size: 13px; font-weight: bolder;">UBAH PROFIL SAYA</span>
								<span><a href="<?php echo site_url();?>penyedia/pengguna" class="btn btn-primary btn-sm">< Kembali</a></span>
							</div>
							<hr>
							<?php
							foreach ($pengguna as $penggunashow):
								...
								$user_password = $penggunashow['user_password'];
							...
							<!-- begin form -->
							<form action="<?php base_url('penyedia/pengguna/ubahprofil') ?>" method="post"
								enctype="multipart/form-data">
								<div class="text-center">
									<div class="col d-flex justify-content-center">
										<div class="card border-0" style="width: 7rem;">
											<span style="font-weight: bolder;">Foto Profil</span>
											<img class="card-img-top" src="<?php echo base_url();?>assets/upload/file_pengguna/penyedia/photo/<?php echo $user_photo;?>" alt="Photo Profile" style="border-radius: 4px; border: 1px solid #ddd; padding: 4px;">
										</div>
										<!-- user_photo -->
										<input name="user_photo" type="file" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" accept="image/*">
										<input name="user_photoold" type="hidden" value="<?php echo $user_photo;?>" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
									</div>
								</div>
								<!-- hidden user_qrcode -->
										<!-- <input name="user_qrcode" type="file" value="default.jpg" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" required accept="image/*">
											<input name="user_qrcodeold" type="hidden" value="default.jpg" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" required> -->
											<hr>
											<div class="row text-center">
												<div class="col d-flex justify-content-center">
													<div class="card border-0" style="width: 15rem;">
														<span style="font-weight: bolder;">KTP</span>
														<img class="card-img-top" src="<?php echo base_url();?>assets/upload/file_pengguna/penyedia/ktp/<?php echo $user_card;?>" alt="KTP" style="border-radius: 4px; border: 1px solid #ddd; padding: 4px;">
													</div>
													<!-- user_card -->
													<input name="user_card" type="file" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" accept="image/*">
													<input name="user_cardold" type="hidden" value="<?php echo $user_card;?>" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
												</div>
											</div>
											<hr>
											<!-- hidden id_user -->
											<input name="id_user" value="<?php echo $id_user;?>" type="hidden" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" required>

											<div class="input-group input-group-sm mb-3">
												<div class="input-group-prepend">
													<span class="input-group-text" id="inputGroup-sizing-sm">Nomor KTP</span>
												</div>
												<!-- no_ktp-->
												<input name="no_ktp" value="<?php echo $no_ktp;?>" type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" required>
											</div>
											<!-- hidden user_level -->
											<input name="user_level" value="<?php echo $user_level;?>" type="hidden" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" required>
											<div class="input-group input-group-sm mb-3">
												<div class="input-group-prepend">
													<span class="input-group-text" id="inputGroup-sizing-sm">Nama</span>
												</div>
												<!-- user_nama -->
												<input name="user_nama" value="<?php echo $user_nama;?>" type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" required>
											</div>

											<!-- hidden jenis_kelamin -->
											<input name="jenis_kelamin" value="<?php echo $jenis_kelamin;?>" type="hidden" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" required>
											<!-- hidden user_email -->
											<input name="user_email" value="<?php echo $user_email;?>" type="hidden" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" required>
											<!-- hidden user_password -->
											<input name="user_password" value="<?php echo $user_password;?>" type="hidden" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" required>
											<!-- hidden user_level -->
											<input name="user_level" value="<?php echo $user_level;?>" type="hidden" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" required>
											<!-- hidden user_status -->
											<input name="user_status" value="<?php echo $user_status;?>" type="hidden" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" required>
											<input name="user_kebijakan" value="<?php echo $user_kebijakan;?>" type="hidden" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" required>
											...
											<div class="input-group input-group-sm mb-3">
												...
												<!--  -->
												<input name="user_hp" value="<?php echo $user_hp;?>" type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" required>
											</div>
											<div class="input-group input-group-sm mb-3">
												<div class="input-group-prepend">
												...
												<!--  -->
												<input name="user_alamat" value="<?php echo $user_alamat;?>" type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" required>
											</div>

											<!-- hidden created -->
											<input name="created" value="<?php echo $created;?>" type="hidden" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" required>

											<!-- button form -->
											<button type="submit" class="btn btn-primary btn-lg btn-block"><span style="font-weight:bold;">Ubah Profil</span>
											</button>
											<!-- end form -->
										</form>
									</div>
