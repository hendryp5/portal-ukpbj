...
<head>
	...
	<title>Profil Saya | UKPBJ Kab. Tanah Laut - Center of Excellence</title>
		...
		<div class="row">
			<div class="col-lg-3 col-md-3 col-sm-12 d-none d-md-block">
				<div class="card">
					<div class="card-body">
						<div class="row">
							<div class="col-xs-4 ml-2 text-center">
								<!-- image profile -->
					...
					<div class="card-body">
						<div>
							<div class="d-flex justify-content-between">
								<span style="color:#b02928; font-size: 13px; font-weight: bolder;">PROFIL SAYA</span>
								<span><a href="<?php echo site_url();?>penyedia/pengguna/ubahprofil" class="btn btn-primary btn-sm">Ubah Profil</a></span>
							</div>
							<hr>
							<?php
							...
							<div class="row text-center">
								<div class="col d-flex justify-content-center">
									<div class="card border-0" style="width: 15rem;">
										<span style="font-weight: bolder;">QR-Code</span>
										<img class="card-img-top" src="<?php echo base_url();?>assets/upload/file_pengguna/penyedia/qrcode/<?php echo $user_qrcode;?>" alt="QRCODE">
									</div>
								</div>
								<div class="col d-flex justify-content-center">
									<div class="card border-0" style="width: 15rem;">
										<span style="font-weight: bolder;">KTP</span>
										<img class="card-img-top" src="<?php echo base_url();?>assets/upload/file_pengguna/penyedia/ktp/<?php echo $user_card;?>" alt="KTP">
									</div>
								</div>
							</div>
							<hr>
							<div class="input-group input-group-sm mb-3">
								...
								<!--  -->
								<input disabled value="<?php echo $no_ktp;?>" type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
							</div>
							<div class="input-group input-group-sm mb-3">
								<div class="input-group-prepend">
									<span class="input-group-text" id="inputGroup-sizing-sm">Status Pengguna</span>
								</div>
								<!--  -->
								<input disabled value="<?php echo $user_level;?>" type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
							</div>
							<div class="input-group input-group-sm mb-3">
								<div class="input-group-prepend">
								...
								<!--  -->
								<input disabled value="<?php echo $user_nama;?>" type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
							</div>
							<div class="input-group input-group-sm mb-3">
								<div class="input-group-prepend">
								...
								<!--  -->
								<input disabled value="<?php echo $jenis_kelamin;?>" type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
							</div>
							<div class="input-group input-group-sm mb-3">
								<div class="input-group-prepend">
								...
								<!--  -->
								<input disabled value="<?php echo $user_email;?>" type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
							</div>
							<div class="input-group input-group-sm mb-3">
								<div class="input-group-prepend">
								...
								<!--  -->
								<input disabled value="<?php echo $user_hp;?>" type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
							</div>
							<div class="input-group input-group-sm mb-3">
								<div class="input-group-prepend">
								...
								<!--  -->
								<input disabled value="<?php echo $user_alamat;?>" type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
							</div>
							<!-- dihidden karna penyedia -->
							<!-- <div class="input-group input-group-sm mb-3">
								<div class="input-group-prepend">
							...
							<div class="input-group input-group-sm mb-3">
								<div class="input-group-prepend">
									<span class="input-group-text" id="inputGroup-sizing-sm">Akun dibuat pada</span>
								</div>
								<!--  -->
								<input disabled value="<?php echo $created;?>" type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
							</div>
						</div>
					</div>
				</div>
