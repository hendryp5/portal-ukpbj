		...
		<div class="row">
			...
			<div class="col">
				<div class="card">
					<div class="card-body">
						<div>
							<span style="color:#b02928; font-size: 13px; font-weight: bolder;">KRITIK & SARAN</span>
							<hr>
							<!--  -->
							<div class="row">
								<div class="col""> 
									<a href="<?php echo base_url()."penyedia/kisar/add"?>" class="btn btn-primary btn-sm"><i class="fa fa-paper-plane" aria-hidden="true"></i> Kirim Kritik & Saran</a>
									<br><br>
									<!-- table -->
									<div class="table-responsive">
										...
										<thead>
											<tr>
												<th colspan="5" class="text-center" style="background-color:white; font-weight: ">Kritik dan saran yang telah dikirimkan.</th>
											</tr>
											<tr align="center">
												<th>No.</th>
												<th>Tanggal</th>
											...
											<tr>
												...
												<td width="10%" align="center">
													<div class="btn-group" role="group" aria-label="Default button group">
														<a href="<?php echo site_url('penyedia/kisar/lihat/'.$datakisar->id_kisar) ?>" class="btn btn-primary btn-sm"><i class="fa fa-search" aria-hidden="true"></i></a>
														</div>
													</td>
												</tr>
											<?php endforeach; ?>
