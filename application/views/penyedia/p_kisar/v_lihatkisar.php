...
<body style="background-color: #F8F8F8">
	...
	<div class="scrollmenu d-block d-sm-none">
	  ...
	  <a href="<?php echo site_url();?>penyedia/kisar" style="color:#B02928;">Kritik & Saran</a>
		...
		<div class="row">
								...
								<nav class="navigation">
									...
									<ul class="mainmenu">
										...
										<li class="activesidebar">
											<a href="<?php echo site_url();?>penyedia/kisar"><img src="https://image.flaticon.com/icons/svg/1141/1141031.svg" width="33px"><span style="margin-left:10px; color:#b02928;"> Kritik & Saran</span></a>
										</li>
										<li>
			...
			<?php endif; ?>
				<div class="card">
					<div class="card-body">
						<div>
							<span style="color:#b02928; font-size: 13px; font-weight: bolder;"><a href="<?php echo base_url()."penyedia/kisar"?>">< Kembali</a></span>
							<hr>
							<!--  -->
							<div class="row">
								<div class="col"">
									<form action="<?php base_url('penyedia/kisar/add') ?>" method="post"
										...
										<div class="form-group">
											<span>
												<b>KRITIK & SARAN YANG TELAH DIKIRIMKAN</b><br>
												<small>Terimakasih sudah mengirimkan kritik & Saran.</small>
											</span><br><br>
											<div class="input-group mb-3">
											  <div class="input-group-prepend">
											    <span class="input-group-text" id="basic-addon1">Tanggal Pengiriman</span>
											  </div>
											  <input type="text" value="<?php echo $datakisar->tanggal?>" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1">
											</div>
											<div class="input-group mb-3">
											  <div class="input-group-prepend">
											    <span class="input-group-text" id="basic-addon1">Nama Pengirim</span>
											  </div>
											  <input type="text" value="<?php echo $datakisar->user_nama?>" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1">
											</div>
											<div class="input-group">
											  <div class="input-group-prepend">
											    <span class="input-group-text">Kritik & Saran</span>
											  </div>
											  <textarea class="form-control" aria-label="With textarea"><?php echo $datakisar->kisar?></textarea>
											</div>
										</div>
									</form>
								</div>
