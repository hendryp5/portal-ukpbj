...
<head>
	...
	<title>Aduan | UKPBJ Kab. Tanah Laut - Center of Excellence</title>
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						...
						<div class="body">
							<div style="margin-bottom:20px;"><a href="<?php echo base_url()."nonpenyedia/aduan/add"?>"
									type="button" class="btn bg-red waves-effect">
									<i class="material-icons">add_circle_outline</i>
									<span><b>BUAT ADUAN</b></span>
								</a></div>
							<div class="table-responsive">
								<table width="100%"
									...
									<thead>
                                        <tr>
                                        <th colspan="5" class="text-center" style="background-color:#F44336;color:white;">DATA ADUAN YANG TELAH DIKIRIM</th>
                                        </tr>
										<tr>
											<th>No.</th>
											<th>Tanggal</th>
										...
										<tr>
											...
											<td width="17%">
												<div class="btn-group" role="group" aria-label="Default button group">
													...
													<a href="<?php echo site_url('penyedia/aduan/lihat/'.$dataaduan->id_aduan) ?>"
